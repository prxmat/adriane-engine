...
| `adriane-c-api` | (polyglot bindings) | ✅ **C ABI foundation** — stable `AdrianeResult` memory ownership plus JSON symbols for Ruby/PHP/Lua/PowerShell/Go/C/C++/Zig/Swift/ObjC/JVM/.NET/BEAM SDKs. |
